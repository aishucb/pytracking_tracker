...
def filter_dashboard():
    unique_tracking_info = get_unique_tracking_info()
    print(unique_tracking_info)
    return render_template('filter_dashboard.html', unique_tracking_info=unique_tracking_info)
